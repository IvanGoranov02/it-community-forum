...
export default async function DebugCountPostsPage() {
  try {
    ...
    // For each category, count posts with direct SQL
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <h1 className="text-3xl font-bold mb-6">Debug Count Posts by Category</h1>
        ...
        <div className="flex space-x-4">
          ...
          <Link href="/debug-category-posts" className="text-blue-500 hover:underline">
            View Category Posts
          </Link>
        </div>
      </div>
    ...
    console.error("Unexpected error in DebugCountPostsPage:", error)
    return (
      <div className="container mx-auto px-4 py-6">
